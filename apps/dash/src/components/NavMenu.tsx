...
import { Home, BarChart3, LogIn, UserPlus, FilePlus2, List, Boxes, Brain, TableProperties, Database, Share2, MessageCircle } from "lucide-react";
...
export function NavMenu() {
  ...
  return (
    <Stack gap="sm" align="start" data-class="dashboard-menu">
      ...
      <Button data-class="menu-item" onClick={() => navigate('/chat')} variant="ghost" size={buttonSize.default} rounded={roundedItem} contentAlign="start" w="full">
