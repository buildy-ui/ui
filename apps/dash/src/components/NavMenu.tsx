...
import { Home, BarChart3, LogIn, UserPlus, FilePlus2, List, Boxes } from "lucide-react";
...
export function NavMenu() {
  ...
  return (
    <Stack gap="sm" align="start">
      ...
      <Button onClick={() => navigate('/blank')} variant="ghost" size={buttonSize.default} rounded={roundedItem} contentAlign="start" w="full">
