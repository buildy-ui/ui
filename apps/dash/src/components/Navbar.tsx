...
import { Atom, Moon, Sun, Menu, BarChart3, Brain } from "lucide-react";
      ...
      <Group justify="between" align="center">
        ...
        {!isMobile && (
          <Group gap="xs" align="center" data-class="navbar-actions">
            <Button title="Stat" data-class="navbar-item" variant="ghost" size={buttonSize.default} rounded={rounded.button} onClick={() => navigate('/stat')}>
              <Icon component="span" lucideIcon={BarChart3} />
              <Text size="sm" c="muted">Stat</Text>
            </Button>
            <Button title="AI Tools" data-class="navbar-item" variant="ghost" size={buttonSize.default} rounded={rounded.button} onClick={() => navigate('/brain')}>
              <Icon component="span" lucideIcon={Brain} />
              <Text size="sm" c="muted">Tools</Text>
            </Button> 
            <Button title="Toggle dark mode" data-class="navbar-item" variant="ghost" size={buttonSize.default} rounded={rounded.button} onClick={toggleDarkMode}>
