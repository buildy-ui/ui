import { Box, Card, Stack, Text, Title, Button, Grid } from "@ui8kit/core";
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="flex items-center gap-2">
                          <Checkbox checked={field.value} onChange={e => field.onChange((e.target as HTMLInputElement).checked)} />
                          <Text size="sm" c="muted">I agree with the terms</Text>
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
