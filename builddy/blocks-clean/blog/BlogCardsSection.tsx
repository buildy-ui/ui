...
export default function BlogCardsSection({ content }: BlogCardsSectionProps) {
  return (
    <section className="w-full bg-background">
      <div className="mx-auto px-4 md:px-6 lg:px-8 flex flex-col gap-8 text-foreground">
        <header className="flex w-full flex-col sm:flex-row gap-4">
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <article key={index} className="flex flex-col gap-4 bg-card border border-border rounded-lg p-6">
              <div
