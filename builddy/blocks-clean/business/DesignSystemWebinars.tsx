      ...
      <div className="mx-auto px-4 md:px-6 lg:px-8 flex flex-col text-center text-foreground">
        ...
        <div className="grid gap-8">
          ...
          <a
            key={index}
            href={webinar.href}
            className="grid bg-card border border-border rounded-lg">
            
              <div className="flex flex-col gap-4 justify-center p-6 text-foreground">
              ...
              <div className="">
                <div className="rounded-lg border border-border">
                  ...
                  width={560}
                  height={315}
                  className="object-cover w-full h-auto transition-transform" />
