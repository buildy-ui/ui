  ...
  return (
    <div className="border-t border-border bg-background">
      <div className="mx-auto px-4 py-4">
        <div className="flex items-center justify-center gap-2 py-2 px-4 border border-border rounded-lg">
          ...
          <LucideChevronDown className="w-3 h-3 text-muted-foreground" />
        </div>
      </div>
    </div>);
