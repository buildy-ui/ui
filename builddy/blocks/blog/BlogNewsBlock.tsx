    ...
    <section className="px-6 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card
            key={index}
            className="group overflow-hidden border border-border bg-card rounded-lg cursor-pointer p-0">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center text-primary font-medium group-hover:gap-3">
                  Read more
