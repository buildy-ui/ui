/*
	...
	Usage:
	  bun packages/@ui8kit/blocks/scripts/preset-generate.ts --blocks testimonial && bun packages/@ui8kit/blocks/scripts/schema-generate.ts --blocks testimonial
...
const outDir = resolve(__dirname, "..", "src", category);
