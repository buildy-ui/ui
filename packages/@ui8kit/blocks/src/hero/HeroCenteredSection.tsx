        ...
        >
          <Stack gap="xl">
            {content.badge && (
              <Group justify="center">
                <Badge 
                  ...
                  data-class="hero-centered-badge"
                >
                  {content.badge}
                </Badge>
              </Group>
            ...
            <Group
              ...
              data-class="hero-centered-actions"
            >
              <Button
                size="lg"
                variant="default"
                className="shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                data-class="hero-centered-button-primary"
              >
                <Box
                  component="span"
              ...
              <Button
                ...
                size="lg"
                className="shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                data-class="hero-centered-button-secondary"
              >
                <Box
                  component="span"
                  className="mr-2 inline-block w-5 h-5"
