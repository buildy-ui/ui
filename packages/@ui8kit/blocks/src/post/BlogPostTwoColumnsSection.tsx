...
interface BlogPostTwoColumnsSectionProps {
  content: {
    blogCategory: string;
    category: string;
    title: string;
...
export const BlogPostTwoColumnsSection = forwardRef<HTMLElement, BlogPostTwoColumnsSectionProps>(
  ({ content }, ref) => {
    return (
...
BlogPostTwoColumnsSection.displayName = "BlogPostTwoColumnsSection";

export const blogPostTwoColumnsSectionTemplate = {
  id: "blogPostTwoColumnsSection",
  name: "Blog Post Two Columns Section",
  description: "Two-column blog post section with title and meta on left, image on right.",
  component: BlogPostTwoColumnsSection,
  defaultContent: {
    blogCategory: "Blog",
    category: "Category",
