...
interface TestimonialsSingleRowSectionProps {
  content: {
    mainTitle: string;
...
export const TestimonialsSingleRowSection = forwardRef<HTMLElement, TestimonialsSingleRowSectionProps>(
  ({ content }, ref) => {
    return (
...
TestimonialsSingleRowSection.displayName = "TestimonialsSingleRowSection";

export const testimonialsSingleRowSectionTemplate = {
  id: "testimonialsSingleRowSection",
  name: "Testimonials Single Row Section",
  description: "Single row of customer testimonials with ratings.",
  component: TestimonialsSingleRowSection,
  defaultContent: {
