...
function generateFullCatalog(): QdrantRecord[] {
  const catalog: QdrantRecord[] = [...baseComponents];
...
const outputPath = join(process.cwd(), 'packages/@ui8kit/brain/.draft/full-catalog.json');
...
export { generateFullCatalog, type QdrantRecord };
